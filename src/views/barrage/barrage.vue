   ...
   <div class="container">
    ...
    <div class="content-opt">
        ...
        <div class="content-input">
            ...
            <button id="send" @click="addMsg" class="btn btn-info">发送</button>
        </div>
    </div>
    <button @click="startPerview" class="btn btn-info">演示</button>
   </div>
</template>
...
export default {
  ...
  data () {
    return {
        textList : ['弹幕', '666', '233333333', 'javascript', 'html', 'css', '前端框架', 'Vue', 'React', 'Angular','测试弹幕效果']
    }
  },
  methods:{
    startPerview(){
